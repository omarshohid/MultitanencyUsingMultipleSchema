...
namespace MultiTanenetWithMultipleSchema.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //        ApplicationUser AppUser = new ApplicationUser() {UserName=user.Email,Id= user.Id+"", Email= user.Email};
            //        //var userM = await UserManager.FindByNameAsync(model.Email);
            //        //if (userM != null)
            //        //{
            //            await SignInManager.SignInAsync(AppUser, true, false);
            //            return RedirectToLocal(returnUrl);
